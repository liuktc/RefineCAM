...
class FunnyBirds(Dataset):
    ...
    def __init__(self, root_dir, mode, image_size=(224,224), get_part_map=False, transform=None):
        """
        Args:
    ...
    def __getitem__(self, idx):
        ...
        if self.get_part_map:
            ...
            part_map = transforms.Resize((image.shape[1], image.shape[2]), interpolation=transforms.InterpolationMode.NEAREST)(part_map)
        else:
            part_map = 0
...
class FunnyBirdsSubset(FunnyBirds):
    def __init__(self, indices=None, *args, **kwargs):
        if indices is None:
    ...
    # def get_intervention(self, class_idx, image_idx, parts_removed):
    #     return super().get_intervention(class_idx, self.indices[image_idx], parts_removed)
    
    # def get_background_intervention(self, class_idx, image_idx, bg_object_id):
    #     return super().get_background_intervention(class_idx, self.indices[image_idx], bg_object_id)